        ...
        <div class="newsletter-content text-center">
            ...
            <div id="mc_embed_signup">
                <form action="https://strategytorevenue.us16.list-manage.com/subscribe/post?u=f7b08109a155ad6a4e8da083d&amp;id=5dc83226a8"
                    ...
                    <div id="mc_embed_signup_scroll" style="display: inherit; width: 100%">
                        ...
                        <div class="btn-container">
                            <input id="mc-embedded-subscribe" name="subscribe" class="btn btn-primary w-100 text-uppercase" type="submit" value="Sign up">
                        </div>
