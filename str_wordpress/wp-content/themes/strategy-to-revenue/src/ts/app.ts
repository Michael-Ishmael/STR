...
import {TimelineMax, TweenLite, Power3, Power4} from "gsap";
...
(function(){
    ...
    //router = new Navigo("http://str.66bytes.com");
...
jQuery(function ($) {
    ...
    $(window).on("load", function() {
        ...
        $('.img-pre-load-class').each(function (i) {
            ...
            let jImg = $(this);
            let dStyle = window.getComputedStyle(this[0]);
...
/*            $('#nl-rev-trigger').click(function () {
        ...
        function initSuccesRollover(){
            ...
            auRoManager2 = new RolloverManager(".success-image-tile", .7, Power4.easeInOut);
