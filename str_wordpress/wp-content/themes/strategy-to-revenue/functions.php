...
/*    if ( is_page_template( 'str-home-page-template.php' ) ) {
...
// bootstrap
function bootstrap_styles_and_scripts()
{


    wp_register_style('bootstrap_css', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css');
    wp_enqueue_style('bootstrap_css');

	wp_register_script('tether_js', 'https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.3/js/tether.js');
	wp_enqueue_script('tether_js');

	wp_register_script('popper_js', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js');
...
add_action('wp_enqueue_scripts', 'bootstrap_styles_and_scripts');
