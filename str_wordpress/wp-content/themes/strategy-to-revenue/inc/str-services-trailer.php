...
$bg_img_src = get_attachment_src_by_slug( 'up-next-services', 'picture-grid-tile-hi-res' );
        ...
        <div class="up-next services">
            <div class="str-pic-hero text-center w-100 d-table center-div">
                <div class="d-table-cell align-middle">
                    ...
                    <h2 class="display-2 clr-white">Our Services and <span class="clr-bright-blue">Expertise</span></h2>
                    <a
