<?php
    ...
    if($this_post !== null) {
	    ...
	    $item_overlay_img_id  = get_post_meta( $this_post->ID, "meta_tailored_appr_overlay_img", true );
	    $item_overlay_img_src = wp_get_attachment_image_src( $item_overlay_img_id, 'overlay-image-column-low-res' )[0];

	    $item_mobile_img_id  = get_post_meta( $this_post->ID, "meta_tailored_appr_mobile_img", true );
                ...
                <div class="col-12 col-md-6 p-0 overlay-column h-100 right">
                    ...
                    <div class="overlay-content h-100">
                        ...
                        <div class="overlay-main clearfix">
                            <h6 class="clr-dark-blue text-uppercase font-weight-bold clr-mid-blue text-center text-md-left">Approach</h6>
