...
if ( $loop_query->have_posts() ) : ?>
    ...
    $this_post = null;
    $next_post = null;
	$tailored_appr_overlay_single_template_path = get_template_directory() . '/inc/str-tailored-appr-overlay-single.php';
	...
	while ( $loop_query->have_posts() ) : $loop_query->the_post();
	    ...
	    if($loop_index == 0){
		    ...
		    if($this_post !== null){
			    include($tailored_appr_overlay_single_template_path);
            }
